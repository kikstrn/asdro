...
export default async function AdminReservationsPage({
  ...
  if (selectedDate) {
    const start =
      new Date(
        `${selectedDate}T00:00:00+02:00`
      );

    const end =
      new Date(
        `${selectedDate}T23:59:59+02:00`
      );
  ...
  //
  // On la fait ici côté serveur pour éviter les problèmes
  // de filtre PostgREST sur une relation imbriquée.
  // ==========================================================
      ...
      <div className="asdro-container py-6 md:py-10">
        ...
        <section>
          ...
          <p className="mt-2 text-sm text-white/50">
            Consultez et gérez les réservations des adhérents.
          </p>
        </section>
        ...
        {params.cancelled ===
          ...
          <div className="mt-6 rounded-2xl border border-green-500/30 bg-green-500/10 p-4">
            ...
            <p className="mt-1 text-sm text-green-200/60">
              La réservation a été annulée et l&apos;adhérent concerné a été informé par e-mail.
            </p>
          </div>
        )}
        ...
        <section className="mt-8 grid gap-4 sm:grid-cols-3">
          ...
          <div className="asdro-card p-5">
            ...
            <p className="mt-2 text-3xl font-bold text-[#b8f536]">
              {upcomingCount}
            </p>
        ...
        <section className="asdro-card mt-8 p-5">
          <form
            method="get"
            className="grid gap-4 md:grid-cols-2 xl:grid-cols-[1.5fr_1fr_1fr_1fr_auto]"
          >
            {/* RECHERCHE */}
            ...
            <div>
              <label
                htmlFor="q"
                className="mb-2 block text-xs font-medium uppercase tracking-wide text-white/40"
              >
                Adhérent
              </label>
            ...
            <div className="flex items-end">
              <button
                type="submit"
                className="asdro-button-primary w-full xl:w-auto"
              >
        ...
        <section className="mt-8 pb-12">
          <div className="flex items-end justify-between gap-4">
            <div>
              ...
              <p className="mt-1 text-sm text-white/45">
                {bookings.length} résultat(s)
              </p>
            </div>
          </div>

          {bookingsError && (
            <div className="asdro-card mt-5 p-6">
          ...
          {!bookingsError &&
            bookings.length ===
              0 && (
              <div className="asdro-card mt-5 p-10 text-center">
                      ...
                      >
                        <div className="flex flex-col gap-6 xl:flex-row xl:items-center xl:justify-between">
                          ...
                          <div className="min-w-0">
                            ...
                            <h3 className="mt-4 text-lg font-bold capitalize">
                              {formatBookingDate(
                                start
                              )}
                            </h3>
                          ...
                          {booking.status ===
                            ...
                            !isPast && (
                              <form
                                ...
                                className="w-full max-w-sm xl:w-auto"
                              >
                                <input
                                  type="hidden"
                                  name="bookingId"
                                ...
                                <button
                                  type="submit"
                                  className="mt-3 w-full rounded-xl border border-red-500/30 px-4 py-3 text-sm font-semibold text-red-400 transition hover:bg-red-500/10"
                                >
